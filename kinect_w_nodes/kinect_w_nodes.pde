...
/*
Node-Nebula Sketcher(NS3)
this came from http://openprocessing.org/sketch/93078
code written by Ben Reynolds: http://www.openprocessing.org/user/22241
*/
Kinect kinect;
...
void draw()
{
 ...
 //set up the 
  ...
  {
    if(v1.x > 0.0){
      addNewNode(v1.x,v1.y,random(-dx,dx),random(-dx,dx));
